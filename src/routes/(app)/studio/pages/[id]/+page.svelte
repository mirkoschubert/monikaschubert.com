...
<div class="space-y-4">
  <div class="flex items-center gap-4">
    ...
    <h1 class="text-2xl font-semibold">
      {isNew ? m.pages_new() : m.pages_edit()}
    </h1>
  </div>
    ...
    <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
      ...
      <div class="w-full space-y-4 lg:w-72 lg:shrink-0">
        ...
        <Card.Root>
          <Card.Header class="pb-3">
            <Card.Title class="text-sm font-medium"
              >{m.pages_card_publish()}</Card.Title
            >
          </Card.Header>
        ...
        <Card.Root>
          <Card.Header class="pb-3">
            <Card.Title class="text-sm font-medium"
              >{m.pages_field_hero_image()}</Card.Title
            >
          </Card.Header>
          <Card.Content class="space-y-3">
            ...
            >
              ...
              <span
                >{uploading
                  ? m.pages_hero_uploading()
                  : m.pages_hero_upload()}</span
              >
              <input
                type="file"
                accept="image/*"
                ...
                <div class="space-y-1.5">
                  <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs {seoTitleClass(seoTitleEn)}">
                      {seoTitleEn.length}/{SEO_TITLE_MAX}{#if seoTitleEn.length > SEO_TITLE_MAX}
                        - too long{/if}
                    </span>
                  </div>
                  <Input
                ...
                <div class="space-y-1.5">
                  <div class="flex items-center justify-between">
                    <Label for="seo_description_en"
                      >{m.pages_field_seo_description()}</Label
                    >
                    <span class="text-xs {seoDescClass(seoDescEn)}">
                      {seoDescEn.length}/{SEO_DESC_MAX}{#if seoDescEn.length > SEO_DESC_MAX}
                        - too long{/if}
                    </span>
                  </div>
                  <textarea
                ...
                <div class="space-y-1.5">
                  <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs {seoTitleClass(seoTitleDe)}">
                      {seoTitleDe.length}/{SEO_TITLE_MAX}{#if seoTitleDe.length > SEO_TITLE_MAX}
                        - too long{/if}
                    </span>
                  </div>
                  <Input
                    id="seo_title_de"
                    name="seo_title_de"
                    bind:value={seoTitleDe}
                  />
                </div>
                <div class="space-y-1.5">
                  <div class="flex items-center justify-between">
                    <Label for="seo_description_de"
                      >{m.pages_field_seo_description()}</Label
                    >
                    <span class="text-xs {seoDescClass(seoDescDe)}">
                      {seoDescDe.length}/{SEO_DESC_MAX}{#if seoDescDe.length > SEO_DESC_MAX}
                        - too long{/if}
                    </span>
                  </div>
                  <textarea
